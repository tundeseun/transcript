    ...
    <section>
        ...
        <div class="box lr">
            ...
            <div class="left">
                ...
                <h1 class="bold">Read the following guidelines carefully before commencing a transcript application:</h1>
                <ul class="mb-1">
                    <li>
                    ...
                    <li>
                        ...
                        Application and payment should only be made via tps.oauife.edu.ng. Payment of cash to any individual, company or agent is prohibited.
